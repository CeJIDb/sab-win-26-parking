...
description: "CI/CD, IaC, автоматизация инфраструктуры и поставки."
model: inherit
readonly: false
---

> Собрано из `.cursor/rules/devops-automator.mdc`. Контекст проекта: `docs/repo-context-compressed.md`. Список субагентов: `@.cursor/agents/AGENTS_INDEX.md`.
