---
name: ux-architect
description: "UX-архитектура: информационная архитектура, навигация, паттерны."
model: inherit
readonly: false
---

> Собрано из `.cursor/rules/ux-architect.mdc`. Контекст проекта: `docs/repo-context-compressed.md`. Список субагентов: `@.cursor/agents/AGENTS_INDEX.md`.
