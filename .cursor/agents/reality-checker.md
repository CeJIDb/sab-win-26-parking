...
description: "Проверка готовности к продакшену по доказательствам и артефактам."
model: inherit
readonly: false
---

> Собрано из `.cursor/rules/reality-checker.mdc`. Контекст проекта: `docs/repo-context-compressed.md`. Список субагентов: `@.cursor/agents/AGENTS_INDEX.md`.
