...
description: "Продукт: discovery, roadmap, приоритизация и метрики."
model: inherit
readonly: false
---

> Собрано из `.cursor/rules/product-manager.mdc`. Контекст проекта: `docs/repo-context-compressed.md`. Список субагентов: `@.cursor/agents/AGENTS_INDEX.md`.
