...
Они соответствуют текущей последовательности слайдов `1.jpg`-`5.jpg` и тексту выступления из [Сценария выступления Demo 3](../demo-3-context-diagram-presentation-3-min.md).
