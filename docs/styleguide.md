...
- Действия системы и внутренние бизнес-правила на этих уровнях также описывайте по-русски. Не используйте технические имена команд, обработчиков и транспортных триггеров в бизнес-сценариях и функциональных моделях.
