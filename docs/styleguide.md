...
- На уровнях концептуального и функционального проектирования называйте атрибуты предметной области на русском языке.
- В технических артефактах — интеграционных контрактах, ERD, DDL и схемах API — используйте английские машиночитаемые идентификаторы атрибутов.
- Не чередуйте русские и английские имена атрибутов в бизнес-описании или одном перечне. Если нужен маппинг между уровнями, используйте отдельные явно обозначенные колонки для бизнес-имени и технического идентификатора.
- На уровнях концептуального и функционального проектирования используйте русские человекочитаемые названия статусов.
- В технических артефактах используйте английские значения перечислений статусов. Не переносите технические enum-значения в бизнес-сценарии и функциональные модели.
