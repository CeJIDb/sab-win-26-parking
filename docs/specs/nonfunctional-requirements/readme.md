...
- [NFR Logging](nfr-logging.md) — фиксирует требования к структурированному журналированию, сквозному `trace_id`, маскированию ПДн и аудиту критичных операций для всех модулей монолита и интеграций.
