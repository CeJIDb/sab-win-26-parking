...
- [UML State Machine TO-BE: договор](uml-state-contract-to-be.md) — фиксирует две оси состояния, маршруты подписания и таблицы переходов для будущей PlantUML-диаграммы.
