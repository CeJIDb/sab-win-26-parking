...
- [UC-12.9 Завершить бронирование автоматически на выезде](../use-case/uc-12-9-complete-booking-auto-exit.md) — использует логику оплаты при завершении бронирования.
- [UC-12.8 Завершить ПС](../use-case/uc-12-8-complete-parking-session.md) — связывает алгоритм оплаты с закрытием парковочной сессии.
