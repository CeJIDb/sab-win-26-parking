# Изображения AS-IS артефактов

Изображения в этом каталоге являются приложениями к каноничным Markdown-документам из соседнего раздела `../`.
...
- Если текстовое описание меняется, синхронизируйте и файл изображения, и связанный `md`.
- Каноничным артефактом для ссылок и review считается `md`, а не изображение.
