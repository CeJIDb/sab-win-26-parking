...
Редактируемый источник визуального приложения — [draw.io (`dfd-l1.drawio`)](assets/dfd-l1.drawio). В текущем изменении визуальные файлы не обновлялись; независимый от транспорта поток подтверждения полной оплаты и уточненный состав проверки доступа зафиксированы в каноничном словаре ниже.
...
| S10 | P15      | P14      | Подтверждение полной оплаты |
...
| S10 P15 → P14 (Подтверждение полной оплаты)                            | Payment сообщает о выполнении финансового условия; Contract Service самостоятельно проверяет подпись, дату, срок и блокировки. Транспорт на L1 не фиксируется                                                                                           |
