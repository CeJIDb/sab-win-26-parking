...
**Дата:** 2026-03-31
**Полный ERD:** [`docs/artifacts/temp-normalized-er-model.md`](../artifacts/temp-normalized-er-model.md)
...
- **[Полная ERD (temp-normalized-er-model)](../artifacts/temp-normalized-er-model.md)** — источник истины, полные типы PostgreSQL
