...
На текущем этапе в `docs/demo-days/demo-4/` уже собраны рабочие материалы по архитектурному блоку:

- сценарий выступления по ES TO-BE с выделенными контекстами;
- черновики слайдов по ES TO-BE с выделенными контекстами.

Эти материалы помогают связать результаты этапа 4 с демонстрацией архитектурного разбиения системы и подготовкой narrative для выступления.
